...
```json
{
  ...
  "publisherRepository" : "harbor1.wizards.lab/acc/spring-sensors-publisher",
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->harbor1.wizards.lab/...(truncated)]
